...
Start here if you are new to StemStudio.
...
Read these articles in order. The overview explains what StemStudio is, the dashboard guide shows how to create and manage projects, and the editor tour gives you orientation for the interface.
...
### AI Hacker
[AI Copilot](../ai/01-ai-copilot.md) → [AI Model Generation](../ai/03-ai-model-generation.md) → [AI NPCs](../ai/02-ai-npcs.md) → [AI Image Generation](../ai/04-ai-image-generation.md)
